...
// engineVersion is what /health reports. It is the version this engine answers as, not the version
// of any database it has open.
const engineVersion = "0.2.0-alpha"
